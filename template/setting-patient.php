							...
							<b-tab title="Profile" active>
								<b-form class="text-center" @submit="updateSetting">
									...
									<div class="form-group">
										...
										<b-col cols="12" md="9" lg="4" class="mobile-form-margin-bottom">
											<b-form-input v-model="setting.phone" type="text" id="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" maxlength="12" placeholder="xxx-xxx-xxxx" required></b-form-input>
										</b-col>
										<b-col cols="12" md="3" lg="2">
											<label>Appointment reminder</label>
										</b-col>
										<b-col cols="12" md="9" lg="4" class="mobile-form-margin-bottom text-left">
											<b-form-checkbox v-model="setting.email_notification" class="registration-notification">Email</b-form-input>&nbsp;&nbsp;
											<b-form-checkbox v-model="setting.sms_notification" class="registration_notification">SMS</b-form-input>
										</b-col>
